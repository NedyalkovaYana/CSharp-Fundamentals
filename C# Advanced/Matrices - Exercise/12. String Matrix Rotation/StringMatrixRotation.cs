    ...
    class StringMatrixRotation
    {
        static void Main()
        {
            ...
            else if (rotateDegrees == 180 || rotateDegrees == 270) // Use List<Stack<char>>
            {
                ...
                PrintMatrix(maxCount, matrix, rotateDegrees);
            }
            else
            {
        ...
        static void PrintMatrix(int maxCount, List<Stack<char>> matrix, int rotateDegrees)
        {
        ...
        static void PrintMatrix(List<Queue<char>> matrix, int rotateDegrees, int maxCount)
        {
           var sb = new StringBuilder();
        ...
        static List<Queue<char>> InitializeQueueMatrix(out int maxCount)
        {
            maxCount = 0;
        ...
        static List<Stack<char>> InitializeStackMatrix(out int maxCount)
        {
            maxCount = 0;
