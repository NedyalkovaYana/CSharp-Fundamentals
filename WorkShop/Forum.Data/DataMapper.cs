    ...
    public class DataMapper
    {
        ...
        public static List<Post> LoadPosts()
        {
            ...
            foreach (string line in dataLines)
            {
                ...
                int[] replyIds = tokens[5].Split(',', StringSplitOptions.RemoveEmptyEntries).Select(int.Parse)
                    .ToArray();
        ...
        public static void SavePosts(List<Post> posts)
        {
            ...
            foreach (Post post in posts)
            {
                ...
                string line = string.Format(userFormat, post.Id, post.Title, post.Content, post.Category, post.Author,
                    string.Join(",", post.Reply));
        ...
        public static void SaveReplies(List<Reply> replies)
        {
            ...
            {
                const string userFormat = "{0};{1};{2};{3}";
                string line = string.Format(userFormat, reply.Id, reply.Content, reply.Author, reply.Post);
