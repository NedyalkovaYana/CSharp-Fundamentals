...
namespace P04_Hospital
{
    public class Program
    {
        public static void Main()
        {
            ...
            string command = InitializeInputData(doktori, departments);
            command = PrintData(doktori, departments);
        }

        private static string PrintData(Dictionary<string, List<string>> doktori, Dictionary<string, List<List<string>>> departments)
        {
        ...
        private static string InitializeInputData(Dictionary<string, List<string>> doktori, Dictionary<string, List<List<string>>> departments)
        {
            string command = Console.ReadLine();
